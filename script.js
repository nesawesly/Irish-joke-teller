...
// SDk za JavaScript sa VoiceRSS sajta
...
function tellMeJoke(joke){
    VoiceRSS.speech({
        key: 'f1f407d24dd2442c880cc253cc96dee0',
        src: joke,
        hl: 'en-ie',
        v: 'Nikola',
        r: 0, 
...
async function getJokes (){
    let joke = ""
    const api = "https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,religious,political,racist,sexist&type=single"
try{
